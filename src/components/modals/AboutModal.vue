<template>
  <modal-inner class="modal__inner-1--about-modal" aria-label="About">
    <div class="modal__content">
      ...
      <small>&copy; 2019 anli5005.</small>
      <small>© 2013-2018 Dock5 Software Ltd.<br>v{{version}}</small>
      <hr>
      anliEdit on <a target="_blank" href="https://github.com/anli5005/anliedit">GitHub</a>
      <br>
      <a target="_blank" href="https://github.com/anli5005/anliedit/issues">Issue tracker</a> — <a target="_blank" href="https://github.com/anli5005/anliedit/releases">Changelog</a>
      <hr>
